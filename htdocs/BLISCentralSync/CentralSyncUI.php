...
putUILog('cloud_sync_ui', 'X', basename($_SERVER['REQUEST_URI'], ".php"), 'X', 'X', 'X');
...
<!--	<tr>
	...
	<tr>
		<td></td>
		<td>
			<input style='font-family:Tahoma' type='cloud_receive' value='<?php echo LangUtil::$pageTerms['CLOUD_RECEIVE']; ?>'>
			<input style='font-family:Tahoma' type='cloud_sync' value='<?php echo LangUtil::$pageTerms['CLOUD_SYNC']; ?>'>
		</td>
	</tr>
